...
\xchapter{Abordagem Proposta}{Estudo de caso no \textit{Home Network System}.}
\label{ch:proposta}
\input{proposta}

%\xchapter{Experimentos}{Experimentos realizados para responder a questão de pesquisa tratada nesta monografia.}
