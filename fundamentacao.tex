...
Interação de características ocorre devido a diversas causas, as quais podem ser resumidas a seguir.
\begin{itemize}\cite{NHLABATSI:2008}
\item \textit{Non-determinism}
\item \textit{Negative impact}
\item \textit{Invocation Order}
\item \textit{Bypass}
\item \textit{Infinite Looping}
\end{itemize}
