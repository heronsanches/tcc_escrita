...
\begin{itemize}
\item Provedor (Service Provider) - cria e oferece o serviço web, este precisa descrever o serviço em um formato padrão, neste caso XML e, publica-o (\textit{Publish}) no Registro de serviço.
